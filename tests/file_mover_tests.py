...
class TestFileMover(unittest.TestCase):
    ...
    @patch('os.makedirs')
    @patch('shutil.move')
    def test_move_files_if_destination_path_not_exists(self, mock_move, mock_makedirs, mock_exists):
    ...
    @patch('os.makedirs')
    @patch('shutil.move')
    def test_move_files_if_destination_path_exists(self, mock_move, mock_makedirs, mock_exists):
