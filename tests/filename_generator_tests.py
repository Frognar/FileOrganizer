...
class TestFilenameGenerator(unittest.TestCase):
    ...
    @patch('file_organizer.filename_generator.now')
    @patch('uuid.uuid4')
    def test_generate_new_filename_using_lowercase(self, mock_uuid, mock_date):
        mock_uuid.return_value = 'f50ec0b7-f960-400d-91f0-c42a6d44e3d0'
        mock_date.return_value = datetime(2023, 3, 4, 14, 5)
    ...
    @patch('file_organizer.filename_generator.now')
    @patch('uuid.uuid4')
    def test_generate_new_filename_without_extension(self, mock_uuid, mock_date):
        mock_uuid.return_value = 'f50ec0b7-f960-400d-91f0-c42a6d44e3d0'
        mock_date.return_value = datetime(2023, 3, 4, 14, 5)
    ...
    @patch('file_organizer.filename_generator.now')
    @patch('uuid.uuid4')
    def test_generate_new_filename_for_empty_name(self, mock_uuid, mock_date):
        mock_uuid.return_value = 'f50ec0b7-f960-400d-91f0-c42a6d44e3d0'
        mock_date.return_value = datetime(2023, 3, 4, 14, 5)
